...
class visualize():
    def __init__(self, data = None, data_path_list = None, configs = 'configs.ini', radius = 2000, if_box = True, save_name = 'test.gif'):
        con = ConfigParser()
    ...
    def update(self, frame: int):
        ...
        lcolor, rcolor, mcolor = "#3498db", "#e74c3c", "#000520"
        for data in self.data:
            for i in self.structure:                
                ...
                if i[2] == 0: self.ax.plot3D(x, y, z, lw=2, c=rcolor)
                elif i[2] == 1: self.ax.plot3D(x, y, z, lw=2, c=lcolor)
                else: self.ax.plot3D(x, y, z, lw=2, c=mcolor)
